...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = KEYMAP_T(
           ...
           KC_LCTL, KC_LGUI, KC_LALT, KC_BSPC, MO(NAVI), KC_SPC, KC_RALT, MO(MACR), MO(DZ60),   KC_RCTL),
  ...
  [HHKB] = KEYMAP_T(
     ...
     * |-----------------------------------------------------------|
     * |      |McL|McD|McR|MwD|   |Lef|Dwn| Up|Rig|   |   |        |
     * |-----------------------------------------------------------|
     * |     Mb5|Mb4|Mb3|Mb2|Mb1|   |   |   |PgD|   |   |      |   |
     * |-----------------------------------------------------------|
     * |    |    |     |       |   |           |    |    |    |    |
     * `-----------------------------------------------------------'
     */
  ...
  [NAVI] = KEYMAP_T(
         ...
         xxxx,    KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D, xxxx,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, xxxx,    xxxx,   xxxx,
         KC_BTN5, KC_BTN4, KC_BTN3, KC_BTN2, KC_BTN1, xxxx,  xxxx,    xxxx,    KC_PGDN, xxxx,    xxxx,    xxxx,   xxxx,
         xxxx,    xxxx,    xxxx,    xxxx,    xxxx,    xxxx,  xxxx,    xxxx,    xxxx,    xxxx),
